            ...
            <div class="card-group mb-0">
                ...
                <div class="card text-white bg-success py-5 d-md-down-none" style="width:44%">
                    <div class="card-body text-center">
                        <div>
                            <img src="img/logo-symbol.png" alt="logo">
                            <h2>Gestión de Agentes de Seguros Leire</h2>
                            <p>Control y gestión de cartera de clientes, referencias y agenda de citas</p>
                        </div>
                    </div>
                </div>
            </div>
